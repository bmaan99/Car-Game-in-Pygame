...
def thing_draw(cho,thingx,thingy):
    thing = pygame.image.load("11.png")
    thing2 = pygame.image.load("12.png")
    thing3 = pygame.image.load("13.png")
...
def game_loop():
    ...
    while not done:
        ...
        car_draw(x,y,"car.png")
        # for obsatacles
        button(740,8,50,50,white,white,"",pause_screen)
        car_draw(740,8,"pause_button.png")
